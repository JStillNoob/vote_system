    ...
    <div class="card ">
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h3 class="mb-0">Voter List</h3>
                </div>
                <div class="col-md-6">
                    <div class="d-flex justify-content-end gap-2">
                        <button class="btn btn-primary " onclick="window.location.href='{{ route('approveVoters') }}'">
                            <i class="fa-solid fa-check"></i>  Approve Voter
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body">
            ...
            <table id="UsersTable" class="table table-bordered ">
                ...
                <tbody>
                    ...
                    @if(optional($user->userType)->userType_name === 'Voter')
                        <tr>
